...
def setup_llm_and_chain():
    ...
    If the answer cannot be found in the context, say "I cannot provide an answer based on the information I was given." and nothing more.
    ...
    llm = ChatGroq(model="llama3-8b-8192", groq_api_key=os.environ.get("GROQ_API_KE"))
